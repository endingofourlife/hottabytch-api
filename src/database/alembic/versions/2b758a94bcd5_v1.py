...
Revision ID: 2b758a94bcd5
Revises: 
Create Date: 2025-09-21 18:26:16.596016
...
def upgrade() -> None:
    ...
    sa.Column('picture', sa.String(length=100), server_default='', nullable=False),
